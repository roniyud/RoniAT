...
public sealed record RiskSettingsResponse(
    ...
    [property: JsonPropertyName("system_managed_protection_enabled")] bool SystemManagedProtectionEnabled,
...
)
{
    public static RiskSettingsResponse FromSettings(RiskSettings settings)
    {
        return new RiskSettingsResponse(
            ...
            settings.RequireSignalApproval,
            ...
            settings.CloseUnmanagedBrokerPositions,
            settings.SystemManagedProtectionEnabled,
